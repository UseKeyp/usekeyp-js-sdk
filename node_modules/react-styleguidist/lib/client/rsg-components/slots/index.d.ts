...
declare const _default: (config?: Rsg.ProcessedStyleguidistConfig) => {
    sectionToolbar: {
        ({ name, example, isolated, href }: import("rsg-components/slots/IsolateButton").IsolateButtonProps): JSX.Element | null;
        propTypes: {
    ...
    exampleTabs: {
        id: string;
        render: import("react").ComponentType<Omit<import("../Editor/Editor").EditorProps, "classes">>;
    }[];
    docsTabButtons: {
        id: string;
        render: {
